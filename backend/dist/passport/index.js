...
function localVerify(username, password, done) {
    return __awaiter(this, void 0, void 0, function () {
        var newUser, user, isVerify, error_1;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    console.log(payload);
                    return [4 /*yield*/, User_1.default.findOne({ username: payload.username })];
                case 1:
                    user = _a.sent();
                    if (!user)
                        return [2 /*return*/, done(null, false)];
...
exports.default = (function () {
    passport_1.default.use(new passport_local_1.Strategy(options, localVerify));
    passport_1.default.use(new passport_jwt_1.default.Strategy(jwtStrategyOption, jwtVerify));
});
